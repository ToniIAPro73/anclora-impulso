...
Declaración de adopción AOS para `anclora-impulso`.

## Metadatos

- Repository Name: anclora-impulso
...
`anclora-impulso` forma parte del ecosistema Anclora como aplicación operativa Next.js.
